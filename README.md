...
-[NVS]
- bus0 DeviceID len=30 ascii="84495820251031014257F283" | addr=0x18
...
- show buses               - Show actual selected Buscount
- set buses <1|2>          - select one or two JBC Stations to connect
- save / load              - Save or Load configuration Data from EEPROM
- erase [eeprom]           - clear NVS/EEPROM and reload defaults (use 'save' to persist) 
- set tstop_work <sec>     - Select the Relay afterrun time in seconds (for the DDE, you can set it up in the Stations Menu)
- set tstop_stand <sec>    - No function! Its for internal testing
- set suctionlevel <0..3>  - No function! Its for internal testing
- set selectflow <0..1000> - No function! Its for internal testing
